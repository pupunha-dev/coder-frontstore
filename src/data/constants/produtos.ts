...
const produtos: Produto[] = [
  {
    ...
    descricao: 'Smartphone Galaxy Z10 Pro com tela AMOLED de 6.7", processador Snapdragon 895 e câmera quádrupla de 108MP.',
    preco: 1999.9,
  ...
  },
  {
    id: 2,
    nome: 'MacBook Pro 16"',
    descricao: 'O MacBook Pro 16" oferece uma experiência incomparável com o chip M1 Pro, 16GB de RAM e 512GB de SSD. Com tela Retina XDR e bateria de longa duração.',
    preco: 7250,
  ...
  },
  {
    ...
    descricao: 'O PC Gamer Thunderbolt X vem com processador Intel i9-12900K, 32GB de RAM e placa de vídeo NVIDIA RTX 3080.',
    preco: 4299.9,
  ...
  },
  {
    ...
    descricao: 'O Console Gamer Ultimate X oferece gráficos de última geração com processador AMD Ryzen, 16GB de RAM e GPU customizada.',
    preco: 2890,
